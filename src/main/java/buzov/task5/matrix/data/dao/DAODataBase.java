package buzov.task5.matrix.data.dao;
...
import buzov.task5.matrix.data.enumDao.TypeTable;
...
public class DAODataBase {
     ...
     */
    private static final String PASSWORD = "2014";

    /**
     * A URL of the database.
     */
    private static final String URL = "jdbc:mysql://localhost:3306/web?zeroDateTimeBehavior=convertToNull";
